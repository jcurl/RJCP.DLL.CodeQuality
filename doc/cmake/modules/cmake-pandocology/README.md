...
The second instruction builds the primary output that we are interested in,
...
In the above case, once run, the output directory will not only have the primary
