namespace NUnit.Framework.HelperClasses
{
    ...
    public class NestedStaticGTypes1Accessor
    {
        ...
        private const string TypeName = "NUnit.Framework.HelperClasses.NestedStaticGTypes1";
    ...
    {
        private const string AssemblyName = "NUnitExtensionsTest";
        private const string TypeName = "NUnit.Framework.HelperClasses.NestedStaticGTypes2`1";
    ...
    {
        private const string AssemblyName = "NUnitExtensionsTest";
        private const string TypeName = "NUnit.Framework.HelperClasses.NestedStaticGTypes3";
        private static readonly PrivateType AccType = new PrivateType(AssemblyName, TypeName);
    ...
    {
        private const string AssemblyName = "NUnitExtensionsTest";
        private const string TypeName = "NUnit.Framework.HelperClasses.NestedStaticGTypes4`1";
        private static readonly PrivateType AccType = new PrivateType(AssemblyName, TypeName, new Type[] { typeof(T) });
    ...
    {
        private const string AssemblyName = "NUnitExtensionsTest";
        private const string TypeName = "NUnit.Framework.HelperClasses.NestedStaticGTypes5`1";
        private static readonly PrivateType AccType = new PrivateType(AssemblyName, TypeName, new Type[] { typeof(T) });
    ...
    {
        private const string AssemblyName = "NUnitExtensionsTest";
        private const string TypeName = "NUnit.Framework.HelperClasses.NestedStaticGTypes6`1";
        private static readonly PrivateType AccType = new PrivateType(AssemblyName, TypeName, new Type[] { typeof(T) });
    ...
    {
        private const string AssemblyName = "NUnitExtensionsTest";
        private const string TypeName = "NUnit.Framework.HelperClasses.NestedGTypes1`1";
        private static readonly PrivateType AccType = new PrivateType(AssemblyName, TypeName, new Type[] { typeof(T) });
