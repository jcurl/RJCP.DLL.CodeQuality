namespace NUnit.Framework
{
    ...
    /// <para>When you derive from this class, it implements a <b>TestFixtureSetUpAttribute</b>
    /// that will automatically deploy files that are decorated with the <see cref="DeploymentItemAttribute"/>. You
    /// should still decorate your classes with the <b>TestFixtureAttribute</b>.</para>
    ...
    public abstract class NUnitExtensions
    {
        ...
        /// about an exception in the <b>TestFixtureSetUpAttribute</b>. Please look at the console output
