namespace RJCP.CodeQuality
{
    ...
    public class PrivateTypeTest
    {
        ...
        {
            Assert.That(() => { _ = new PrivateType(AccessorTest.AssemblyName, string.Empty); }, Throws.TypeOf<ArgumentException>());
        }
        ...
        {
            PrivateType privType = new(AccessorTest.AssemblyName, "RJCP.CodeQuality.HelperClasses.InternalClassTest");
        ...
        {
            PrivateType privType = new(typeof(PublicClassTest));
