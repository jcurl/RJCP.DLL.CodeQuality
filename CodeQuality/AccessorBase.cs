namespace RJCP.CodeQuality
{
    ...
    public abstract class AccessorBase
    {
        ...
        /// <summary>
        /// A bit mask comprised of one or more <see cref="BindingFlags"/> that specifies how the search for
        ...
        /// <exception cref="ArgumentNullException"><paramref name="eventName"/> or <paramref name="handler"/> is <see langword="null"/>.</exception>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="eventName"/> or <paramref name="userSource"/> is <see langword="null"/>.</exception>
        /// <exception cref="MissingMemberException">The given <paramref name="eventName"/> doesn't exist.</exception>
        /// <remarks>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="type"/> or <paramref name="methodName"/> is <see langword="null"/>.</exception>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="type" /> or <paramref name="name" /> is <see langword="null" />.</exception>
